...
<a name="tree"></a>
### Command `tree` - List Objects in a tree format

`tree` command lists files, objects and directories in a tree format.
...
_Example: tree all buckets and objects on play/bucket._
